        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="mb-8">
            ...
            <Card className="shadow-xl border-0">
              ...
              <CardContent>
                {userEmail && userEmail !== 'guest@example.com' ? (
                  ...
                  <div className="text-center py-12">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-r from-blue-100 to-purple-100 flex items-center justify-center mx-auto mb-6">
          ...
          <TabsContent value="analytics">
            <Card className="shadow-xl border-0">
              ...
              <CardContent>
                <div className="text-center py-12">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-r from-blue-100 to-cyan-100 flex items-center justify-center mx-auto mb-6">
          ...
          <div className="text-center">
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                {/* <Magic className="h-12 w-12 text-purple-600 animate-pulse" /> */}
              </div>
            </div>
