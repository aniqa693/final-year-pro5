...
export default function VideoScriptGeneratorPage() {
  ...
  const videoTypes = [
    ...
    // { value: 'tiktok', label: 'TikTok', icon: TikTok, color: 'bg-gradient-to-r from-black to-gray-800' },
    ...
    { value: 'vlog', label: 'Vlog', icon: Video, color: 'bg-gradient-to-r from-orange-500 to-yellow-500' },
  ];
...
Generated by AI Video Script Generator
      ...
      if (data.saveInfo?.saved) {
        ...
        toast.success(
          <div className="flex items-center gap-2">
            ...
            <span>Script saved to your account! 🎉</span>
          </div>,
          { duration: 4000 }
        );
      } else {
  ...
  const VideoIcon = videoTypes.find(v => v.value === videoType)?.icon || Video;
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold text-gray-900">{saveStatus.saved ? 'Saved' : '-'}</div>
                  ...
                  <CardContent className="pt-6 space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className="h-14 text-lg border-2 border-gray-300 focus:border-red-500 pl-12 text-gray-900"
                        />
                          ...
                          <div className="flex flex-wrap gap-2">
                            {topicSuggestions.map((suggestion, idx) => (
                              <button
                                ...
                                className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-300 hover:border-red-400 hover:shadow-md transition-all duration-200 hover:scale-105 bg-white"
                              >
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        className="min-h-[100px] border-2 border-gray-300 focus:border-purple-500 text-gray-900"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <Select value={videoType} onValueChange={setVideoType}>
                          <SelectTrigger className="border-2 border-gray-300 h-12 text-gray-900">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                          {durations.map((dur) => (
                            <Button
                              ...
                              className={`h-10 ${duration === dur.value ? 'bg-red-500 hover:bg-red-600' : 'border-gray-300 hover:bg-gray-100'}`}
                            >
                              {dur.label}
                            </Button>
                          ))}
                    ...
                    <Button
                      ...
                      size="lg"
                      className="w-full h-14 text-lg bg-gradient-to-r from-red-500 via-orange-500 to-purple-500 hover:from-red-600 hover:via-orange-600 hover:to-purple-600 shadow-lg hover:shadow-xl transition-all duration-300 text-white"
                    >
                      {loading ? (
                        <>
