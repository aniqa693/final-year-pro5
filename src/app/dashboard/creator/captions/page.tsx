...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const checkUserSession = () => {
      // First try to get from cookies (more secure)
    ...
    const handleStorageChange = (e: StorageEvent) => {
      if (e.key === 'userEmail' || e.key === 'userRole') {
        checkUserSession();
      }
    };
    ...
    try {
      ...
      const response = await fetch('/api/generate-caption', {
        ...
        body: JSON.stringify({ 
          ...
          userEmail: isLoggedIn ? userEmail : 'guest@example.com'
        }),
      });
        ...
        <div className="mb-8">
          ...
          {captions.length > 0 && (
            ...
            >
              ...
              <Card className="text-center p-4 bg-gradient-to-br from-pink-50 to-pink-100 border border-pink-200">
            ...
            {captions.length > 0 ? (
              ...
              <Card className="border-2 border-dashed border-purple-300 bg-purple-50/80">
                <CardContent className="py-16 text-center">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-r from-purple-100 to-pink-100 flex items-center justify-center mx-auto mb-8">
