...
export const metadata: Metadata = {
  title: 'Creator Dashboard - SocialAI',
  description: 'Content creation and social media management dashboard',
};
...
export default async function CreatorDashboardPage() {
  ...
  // 1. User is currently in creator role AND
  // 2. Their original role was admin (stored when admin switched roles)
  ...
  return (
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-pink-50 to-rose-50 border border-pink-200 rounded-xl p-6">
          ...
          {/* Conditionally show ResetToAdminButton */}
