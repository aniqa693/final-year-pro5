...
const creatorNavItems = [
  ...
  },
  {
    ...
    href: "/dashboard/creator/ai-visual",
    icon: Palette,
    subItems: [
      { title: "Post Generator", href: "/dashboard/creator/visaul/post" },
      { title: "Thumbnail Generator", href: "/dashboard/creator/ai-visual/thumbnail" },
      { title: "Post Enhancer", href: "/dashboard/creator/ai-visual/enhancer" },
    ],
  },
  {
    title: "Trend finder",
