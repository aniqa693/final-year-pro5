...
export default function AdminSidebar({ className, onLogout }: AdminSidebarProps) {
  ...
  return (
    <div
      className={cn(
        "flex flex-col h-full bg-gradient-to-b from-gray-900 to-black text-white border-r border-gray-800 transition-all duration-300",
    ...
    >
      ...
      <div className="p-6 border-b border-gray-800">
        <div className="flex items-center justify-between">
          ...
          {isCollapsed && (
            <div className="w-8 h-8 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg flex items-center justify-center mx-auto">
              <Shield className="w-5 h-5" />
            </div>
          )}
          <Button
              ...
              {hasSubItems ? (
                <button
                  ...
                  className={cn(
                    ...
                    isItemActive && "bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-l-4 border-purple-500",
                    isCollapsed && "justify-center"
                  )}
                >
                  <div className="flex items-center space-x-3">
