...
export default function AnalystSidebar({ className, onLogout }: AnalystSidebarProps) {
  ...
  return (
    <div
      className={cn(
        "flex flex-col h-full bg-gradient-to-b from-emerald-50 to-green-50 border-r border-emerald-200 transition-all duration-300",
              ...
              {hasSubItems ? (
                <button
                  ...
                  className={cn(
                    ...
                    isItemActive && "bg-gradient-to-r from-emerald-50 to-green-50 border-l-4 border-emerald-500 text-emerald-700",
                    isCollapsed && "justify-center"
                  )}
                >
                  <div className="flex items-center space-x-3">
